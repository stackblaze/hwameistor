...
type BackupConfigSpec struct {
	...
	// schedule via the "hwameistor.io/backup-schedule" annotation.
	//+kubebuilder:validation:Optional
	Schedule string `json:"schedule,omitempty"`

	// Retention is the default retention policy. Per-PVC annotations of the
	// form "hwameistor.io/backup-retention-<bucket>" override individual buckets.
	//+kubebuilder:validation:Optional
	Retention RetentionSpec `json:"retention,omitempty"`

	// Selector restricts which PVCs are backed up. An empty selector matches
	// every PVC bound to a hwameistor StorageClass. PVCs annotated
	// "hwameistor.io/backup=false" are always skipped.
	//+kubebuilder:validation:Optional
	...
	// Can be overridden per-PVC via "hwameistor.io/backup-keep-snapshot".
	...
	// VolumeSnapshotClass for the hwameistor driver.
	//+kubebuilder:validation:Optional
...
// BackupConfig is the cluster-scoped configuration for hwameistor backup/restore
// via restic.
